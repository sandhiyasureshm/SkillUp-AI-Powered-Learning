...
export default function Login() {
  ...
  const handlePasswordLogin = async (e) => {
    ...
    setMessage("");
    try {
      const res = await fetch("https://skillup-ai-powered-learning.onrender.com/login", {
        method: "POST",
  ...
  const handleSendOtp = async (e) => {
    ...
    setMessage("");
    try {
      const res = await fetch("https://skillup-ai-powered-learning.onrender.com/api/send-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setMessage("");
    try {
      const res = await fetch("https://skillup-ai-powered-learning.onrender.com/api/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
const handleResetPassword = async () => {
  ...
  try {
    const res = await fetch("https://skillup-ai-powered-learning.onrender.com/api/reset-password", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
