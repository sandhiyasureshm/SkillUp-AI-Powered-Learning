...
function ProfilePage() {
        ...
        const fetchUser = async () => {
            try {
                ...
                const res = await axios.get(
                    `https://skillup-ai-powered-learning.onrender.com/api/users/${encodeURIComponent(userEmail)}`
                );
    ...
    try {
        const res = await axios.put(
            ...
            `https://skillup-ai-powered-learning.onrender.com/api/users/change-password/${encodeURIComponent(userEmail)}`,
            {
