...
const Courses = () => {
    ...
    const fetchAllCourses = async () => {
        try {
            const response = await axios.get('http://skillup-ai-powered-learning-1.onrender.com/courses');
    ...
    const handleInterested = async (courseId) => {
        ...
        try {
            const response = await axios.post('http://skillup-ai-powered-learning-1.onrender.com/add-interest', {
                userId: user._id,
                courseId
            });
