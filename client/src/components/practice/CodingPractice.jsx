...
const CodingPractice = () => {
    ...
    const handleGenerateChallenge = async () => {
        ...
        try {
            const response = await axios.post("http://skillup-ai-powered-learning-1.onrender.com/api/coding/generate-coding-challenge", {
    ...
    const handleSubmitCode = async () => {
        ...
        try {
            const response = await axios.post("http://skillup-ai-powered-learning-1.onrender.com/api/coding/evaluate-code", {
                challenge: challenge,
                userCode: userCode,
                language: language,
            });
