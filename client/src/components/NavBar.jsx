    ...
    const fetchDropdowns = async () => {
      try {
        const [coursesRes, tutorialsRes, practiceRes, examsRes] =
          await Promise.all([
            axios.get("https://skillup-ai-powered-learning.onrender.com/api/dropdowns/courses"),
            axios.get("https://skillup-ai-powered-learning.onrender.com/api/dropdowns/tutorials"),
            axios.get("https://skillup-ai-powered-learning.onrender.com/api/dropdowns/practice"),
            axios.get("https://skillup-ai-powered-learning.onrender.com/api/dropdowns/exams"),
          ]);
